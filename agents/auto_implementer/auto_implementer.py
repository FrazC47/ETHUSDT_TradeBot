...
AUTO_CONFIG = {
    ...
    'agent_file': '/root/.openclaw/workspace/ETHUSDT_TradeBot/ethusdt_agent.py',
    'config_file': '/root/.openclaw/workspace/ETHUSDT_TradeBot/config/agent.conf',
    'versions_dir': '/root/.openclaw/workspace/ETHUSDT_TradeBot/versions',
    'backtest_dir': '/root/.openclaw/workspace/ETHUSDT_TradeBot/backtest_results',
    'suggestions_dir': '/root/.openclaw/workspace/ETHUSDT_TradeBot/analysis',
    'state_file': '/root/.openclaw/workspace/ETHUSDT_TradeBot/auto_implementer/state.json',
    'log_file': '/root/.openclaw/workspace/ETHUSDT_TradeBot/auto_implementer/auto_implementer.log',
