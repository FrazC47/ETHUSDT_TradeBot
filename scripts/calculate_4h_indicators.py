#!/usr/bin/env python3
"""
ETHUSDT 4-Hour Indicator Calculator
Calculates all 99+ technical indicators for 4h (4h) timeframe
...
INPUT_FILE = DATA_DIR / "ETHUSDT_4h.csv"
...
def merge_additional_data(df, funding_df, oi_df, ls_df):
    """Merge funding rate, OI, and L/S ratio with 4h candles"""
    ...
    if oi_df is not None and len(oi_df) > 0:
        ...
        df_reset['oi_24h_change'] = df_reset['open_interest'].pct_change(96) * 100  # 6 periods = 24h
...
def calculate_indicators(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # ========== CANDLESTICK PATTERNS (4-Hour Only) ==========
...
def main():
    """Main function"""
    print("="*70)
    print("ETHUSDT 4-Hour Indicator Calculator")
    print("="*70)
