#!/usr/bin/env python3
"""
ETHUSDT 5-Minute Data Fetcher - Trade Spotlight
Lightweight fetcher for precision entry/exit timing
"""
...
def get_last_timestamp():
    csv_file = DATA_DIR / "ETHUSDT_5m.csv"
...
def main():
    print(f"[{datetime.now()}] 5m fetch - Trade Spotlight")
    ...
    if data:
        ...
        print(f"[{datetime.now()}] Saved {count} 5m candles")
        return count
    return 0
