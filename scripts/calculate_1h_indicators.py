#!/usr/bin/env python3
"""
ETHUSDT 1H Indicator Calculator
Calculates 139 technical indicators for 1h (1-hour) timeframe
"""
...
INPUT_FILE = DATA_DIR / "ETHUSDT_1h_2022_2024.csv"
...
def calculate_indicators(df: pd.DataFrame) -> pd.DataFrame:
    ...
    for period in [10, 20]:
        df[f'hist_vol_{period}'] = df['log_returns'].rolling(window=period).std() * np.sqrt(365 * 24) * 100
...
def main():
    print("="*70)
    print("ETHUSDT 1H Indicator Calculator")
    print("="*70)
